<footer class="page-footer">
	...
	<div class="footer-nav">
		<div class="container clearfix">
			...
			<div class="footer-nav__col footer-nav__col--contacts">
				...
				Head Office: Kentrong Fashion.<br>
				Revolver Agus Salim,STM, Gunungkidul.
			</address>
				<div class="phone">
					Telephone:
					<a class="phone__number" href="tel:0123456789">(0274) 391019</a>
				</div>
				<div class="email">
					Email:
					<a href="mailto:support@yourwebsite.com" class="email__addr">kentrongpedia@gmail.com</a>
				</div>
			</div>
	...
	<div class="page-footer__subline">
		<div class="container clearfix">
			...
			<div class="copyright">
				&copy; 2024 Kentrong Pedia&trade;
			</div>

			<div class="developer">
				Dev by Kentrong Pedia
			</div>

			<div class="designby">
				Design by Kentrong Pedia
			</div>
		</div>
	</div>
</footer>
